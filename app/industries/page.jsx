  ...
  return (
    <section className="py-16 bg-[#E5EBFC]">
      <div className="container mx-auto px-4">
        <h1 data-aos="fade-up" className="text-[#1C398E] 3xl md:text-5xl font-bold text-center mb-9">
          Industries We Serve
        </h1>
        <p data-aos="zoom-in"className="text-center max-w-4xl mx-auto text-gray-600 text-lg mb-12">
        ...
        {/* grid */}
        <div data-aos="fade-up" data-aos-delay="6000" className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-17">
          {industries.map(({ title, tag, img }) => (
            <div className="relative group overflow-hidden rounded-lg shadow-lg">
              ...
              {/* overlay */}
              <div
                className="absolute inset-0 bg-blue-900/70 flex flex-col items-center justify-center
                 text-center text-white px-4 opacity-0 translate-y-4
                 group-hover:opacity-100 group-hover:translate-y-0
                 transition-all duration-500"
              >
                <h3 className="text-2xl font-bold mb-1">{title}</h3>
                <p className="text-white text-2xl font-semibold text-sm italic">
                  {tag}
                </p>
              </div>
            </div>
