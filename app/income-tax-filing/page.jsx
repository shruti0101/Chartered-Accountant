    ...
    <div className="flex flex-col lg:flex-row items-center gap-10">
      ...
      <div className="flex-1">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mb-4">
          Ensure compliance, claim refunds, and strengthen your financial records with
          expert-guided ITR filing by <strong>Chintan Agrawal & Co.</strong> —
          your trusted Chartered Accountant partner.
        </p>
        <p className="text-lg text-gray-600 max-w-2xl">
          Whether you’re a salaried professional, business owner, NRI, or freelancer —
          our experienced team ensures accurate, timely, and stress-free return filing
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700 text-base md:text-lg mb-4">
            An Income Tax Return (ITR) is a formal declaration submitted to the Income Tax Department of India, reporting your income, deductions, taxes paid, and any refund claimed for a specific financial year. It is a legal obligation for eligible individuals and entities, and also a smart financial move for long-term benefits.
          </p>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-2">
              <FaCheckCircle className="text-green-600 mt-1" />
              <span>
                <strong>Ensure Legal Compliance:</strong> Filing ITR keeps you compliant with Indian tax laws and avoids penalties.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="text-green-600 mt-1" />
              <span>
                <strong>Claim Tax Refunds:</strong> If excess TDS or advance tax was paid, filing ITR is essential to get refunds.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="text-green-600 mt-1" />
              <span>
                <strong>Build Financial Credibility:</strong> ITR documents are vital for visa applications, loans, and tenders.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="text-green-600 mt-1" />
              <span>
                <strong>Carry Forward Losses:</strong> Filing ITR enables you to carry forward capital or business losses to future years.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <FaCheckCircle className="text-green-600 mt-1" />
              <span>
                <strong>Proof of Income:</strong> Serves as official income proof for self-employed professionals and freelancers.
              </span>
            </li>
          </ul>
        </div>
